...
# ans: "gini" is the default value for split. which means split on "gini index"

# Q2: what are the meanings of these control parameters?
#          1- "minsplit=2"
# ans: minsplit is the minimum number of observations that must exist in a node in order for a split to be attempted.
#
#          2- "maxdepth=3"
#
#          3- "minbucket=4"
